...
func _physics_process(delta):
	...
	$HUD/ProgressBar.value = Global.vida
	$HUD/Monedas.text = "MONEDAS: " + String(Global.monedasJuntadas)
	...
	if abs(vv - vv_past) > 20: #distancia mínima para daño
		Global.vida -= abs(vv - vv_past) * 1 #daño según velocidad
	vv_past = vv
